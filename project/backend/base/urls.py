...
from .views import (
    ...
    delete_video_detections, camera_specific_detections, get_uploaded_video_details
)
...
urlpatterns = [
    ...
    path('detections/camera/<int:camera_id>/', camera_specific_detections, name='detections_by_camera'),
    path('uploaded_videos/upload_video/', upload_video, name='upload_video'),
    path('uploaded_videos/', list_uploaded_videos, name='uploaded_videos_list'),
    path('detections/<int:video_id>/delete/', delete_video_detections, name='delete_detections'),
    path('uploaded_videos/<int:video_id>/', get_uploaded_video_details, name='uploaded_video_detail'),
